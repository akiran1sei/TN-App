      ...
      <div className={styles.delete_data}>
        <div className={styles.delete_main}>
          <div className={styles.delete_list}>
            ...
            <div className={`${styles.delete_item} ${styles.delete_username}`}>
              ...
              <div className={styles.delete_item_value}>
                ...
                <table className={styles.delete_item_aroma_table}>
                  <thead>
                    <tr>
                      <th></th>
                      <th className={styles.delete_item_aroma_header}>強さ</th>
                      <th className={styles.delete_item_aroma_header}>／質</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className={`${styles.delete_item} ${styles.delete_cleancap}`}>
            ...
            <div className={`${styles.delete_item} ${styles.delete_mouthfeel}`}>
